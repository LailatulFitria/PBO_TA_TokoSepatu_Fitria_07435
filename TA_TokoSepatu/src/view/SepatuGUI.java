...
public class SepatuGUI {
    ...
    JButton btnubahsepatu,btnhapus,btnback,btntambahsepatu; 
    ...
    public SepatuGUI(){
        ...
        tabelsepatu.setModel(sepatu_c.ListSepatu());
        ...
        btntambahsepatu = new JButton("Tambah Sepatu");
        btntambahsepatu.setBounds(50,470,150,30);
        Sepatu.add(btntambahsepatu);
        
        btnubahsepatu = new JButton("Ubah Sepatu");
        btnubahsepatu.setBounds(50,510,150,30);
        Sepatu.add(btnubahsepatu);
        ...
        btntambahsepatu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    AllObjController.sepatu.insert(kodesepatu, merek, ukuran, harga, jumbarang);
        ...
        btnubahsepatu.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                try{
                    String kodesepatu = textkodesepatu.getText();
                    ...
                    String harga = textharga.getText();
                    int jumbarang = Integer.valueOf(textjumbarang.getText());
                    AllObjController.sepatu.update(index, kodesepatu, merek, ukuran, harga, jumbarang);
                    JOptionPane.showMessageDialog(null,"Ubah Sepatu Sukses","Information", JOptionPane.INFORMATION_MESSAGE);
                    reset();
                    tabelsepatu.setModel(AllObjController.sepatu.ListSepatu());
                }catch(Exception exception){
                    JOptionPane.showMessageDialog(null,"Fomat penulisan salah","Information", JOptionPane.INFORMATION_MESSAGE);
